...
Route::get('/blogs/new','BlogsController@create')->name('blogs.new');
//softdeletes move to trash and delete permanent
...
Route::delete('/blogs/{id}/delete','BlogsController@destroy')->name('blogs.delete');
